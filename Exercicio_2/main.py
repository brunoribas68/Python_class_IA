...
assert min_count(['casa', 'o gato', 'gato', 'subiu', 'subiu no', 'cão', 'o cachorro', 'telhado', 'no telhado'],
...
class NaiveBayesClassifier:
    ...
    def train(self, messages: Iterable[Message],
              minimal_counts: int) -> None:  # novo parâmetro de entrada para a quantidade mínima de aceitaqvel de palavras
        ...
        for message in messages:
            ...
            for token in tokenize(message.text):
                if token in common_tokens:  # verifica se a palavra pode esta na lista de palavras que cumprem o critério mínimo.
